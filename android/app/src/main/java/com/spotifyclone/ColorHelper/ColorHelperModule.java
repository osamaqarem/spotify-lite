...
public class ColorHelperModule extends ReactContextBaseJavaModule {
    ...
    ColorHelperModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    @ReactMethod
    public void getColorFromURL(String url, ReadableMap config, Promise promise) {
        try {
